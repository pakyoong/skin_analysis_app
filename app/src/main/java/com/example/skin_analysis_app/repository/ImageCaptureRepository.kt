 ...
 */
class ImageCaptureRepository internal constructor(private val rootDirectory: File, private val userName: String) {
    companion object {
        const val TAG = "ImageCaptureRepository"

        private const val PHOTO_EXTENSION = ".jpg"

        fun create(context: Context, userName: String): ImageCaptureRepository {
            ...
            return ImageCaptureRepository(file, userName)
        }
    ...
    fun createImageOutputFile(): File = File(rootDirectory, generateFilename(userName, PHOTO_EXTENSION))

    /* private fun generateFilename(extension: String): String =
        UUID.randomUUID().toString() + extension */
    private fun generateFilename(userName: String, extension: String): String =
        userName + "_" + SimpleDateFormat("yyyyMMdd_HHmmss", Locale.getDefault()).format(Date()) + extension
